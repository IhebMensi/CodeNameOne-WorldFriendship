 ...
 * @author Marwa
 */
public class testaff2_1 extends SideMenuBaseForm {
      Form f,form;
    SpanLabel lb;
    ...
    public testaff2_1(Resources res) {
...
//                 form.getToolbar().addCommandToLeftBar("back", null, (ev)-> new HomeForm().HomeForm(res).show());
   ...
   img1=URLImage.createToStorage(enc1,url1 , url1, URLImage.RESIZE_SCALE);
       ...
       F3.add(imgv1);
                    ...
                    Utilisateur u1 = new Utilisateur(1);
                     Button participerbtn = new Button("Supprimer");
 ...
 participerbtn.addActionListener((pi) -> {
  ...
  Button annulerbtn = new Button("Modifier");
        annulerbtn.setUIID("SkipButton");
 
  annulerbtn.addActionListener((pi) -> {
                                        ModifEve a=new ModifEve(e,res);
        a.getF().show();
   
        });
  Button like = new Button("participer");
...
Dialog.show(str, str , "OK", null);
    ...
    Button dislike = new Button("Annuler");
