 ...
 * @author Marwa
 */
public class signalerevenement {
     private Utilisateur user_id ;
    private Evenement even_id;

    public signalerevenement() {
    }

    public signalerevenement(int user_id, int even_id) {
        this.user_id = new Utilisateur(user_id);
        this.even_id = new Evenement(even_id);
    }

    public signalerevenement(int user_id) {
        this.user_id = new Utilisateur(user_id);
    }

//    public signalerevenement(int even_id) {
//       this.even_id = new Evenement(even_id);
//    }
 ...
 public Evenement getEven_id() {
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + Objects.hashCode(this.even_id);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final signalerevenement other = (signalerevenement) obj;
    ...
    public String toString() {
        return "signalerevenement{" + "user_id=" + user_id + ", even_id=" + even_id + '}';
    }
